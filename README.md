...
<!-- tensortonic:start -->
# Ahmed's TensorTonic Solutions

Verified machine learning implementations completed on [TensorTonic](https://www.tensortonic.com).

<p align="center">
  <img src="https://www.tensortonic.com/api/badge/ahmedishere.svg" alt="TensorTonic Verified Solutions" width="100%" />
</p>
...
| Gradient of Multivariate Linear Regression Loss | Compute the multivariate linear-regression sum-of-squared-errors gradient with respect to weights and bias. | https://www.tensortonic.com/study-plans/math-calculus/calculus-linreg-gradient |
| Higher-Order Derivatives & Loss Curvature | Compute first and second derivatives for MSE, cross-entropy, and Huber losses to compare their local curvature. | https://www.tensortonic.com/study-plans/math-calculus/calculus-loss-curvature |
...
| Convex Polytope Membership | Test whether a query point satisfies every linear inequality defining a convex polytope. | https://www.tensortonic.com/study-plans/math-optimization/optim-convex-set-membership |
...
| Classify a Critical Point from the Hessian | Classify a stationary point as a minimum, maximum, or saddle from the eigenvalues of its Hessian. | https://www.tensortonic.com/study-plans/math-optimization/optim-critical-point-classification |
...
| Vanilla Gradient Descent | Implement vanilla gradient descent to minimize a two-variable function from a given starting point, returning the full optimization trajectory. | https://www.tensortonic.com/study-plans/math-optimization/optim-vanilla-gd |
...
View my verified ML profile: [TensorTonic profile](https://www.tensortonic.com/profile/ahmedishere)
<!-- tensortonic:end -->
